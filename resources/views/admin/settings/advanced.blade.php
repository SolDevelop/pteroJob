    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="" method="POST">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Free Servers</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="control-label">Free Servers' Max Ram</label>
                                <div>
                                    <input type="number" required class="form-control" name="pterodactyl:freeram" value="{{ config('pterodactyl.freeram') }}">
                                    <p class="text-muted small">The max ram limit in all node for free servers.</p>
                                </div>
                            </div>
